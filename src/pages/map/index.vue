<template>
    <div class="map">
        ...
        <map class="content" id="map" longitude="114.37813409183398" latitude="36.124419929128254" :markers="markers" scale="18" @tap="toNav">
        </map>
        <div class="call">
...
export default {
  ...
  data () {
    return {
      markers: [{
        ...
        id: 0,
        latitude: 36.124419929128254,
        longitude: 114.37813409183398,
        width: 50,
        height: 50
      }]
    }
  ...
  methods: {
    ...
    linkHe () {
      wx.makePhoneCall({
        phoneNumber: '16601046351'
      })
    },

    linkShe () {
      wx.makePhoneCall({
        phoneNumber: '18515666823'
      })
    }
  }
}
